      ...
      <div className="bg-white mt-0 overflow-hidden mb-8">
        ...
        <p className='w-10/12 m-auto mt-4 font-mono leading-loose'>
          Apasionado por el diseño Fron End, disfruto de resolver problemas con
           <span className='bg-gradient-to-r from-violet-900/50 via-purple-800/50 to-pink-500/50  font-bold'> soluciones creativas y robustas</span>. 
        </p>
        <p className='w-10/12 m-auto mt-4 font-mono leading-loose'>
        Estoy siempre en búsqueda de
          oportunidades que me permitan seguir <strong className=' bg-gradient-to-r from-violet-900/50 via-purple-800/50 to-pink-500/50 font-display font-bold '> aprendiendo, enseñando y
          disfrutando</strong>.
        </p>
      </div>
    );
